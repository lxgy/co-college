...
$(function () {
    ...
    var uploader = Qiniu.uploader({
        ...
        chunk_size: '4mb',
        uptoken_url: '/qiniu',
        // uptoken: "F-FOuyp7JH3RsLuXnxaHYtFjYKTe5nEzO-9bt0Pw:leWHH_x-zkgygbjzwU6Irlhlef0=:eyJzY29wZSI6Imdhbmx1cmVuIiwiZGVhZGxpbmUiOjE1NDcxMDYyMzZ9",
        ...
        init: {
            ...
            'FileUploaded': function (up, file, info) {
                ...
                var download = res;
                var str = "<tr id='" + res + "'><td><img style='width:400px;height:200px'  src=" + download + " /></td ><td hidden='hidden'><input type='text' class='input-text' disabled='disabled' value='" + download + "' placeholder='' name='pic_src'  id='' name='class_author'></td><td><button class='btn btn-danger pic-del'>取消该图片</button></td><td></td></tr>"
                $("#table-data").append(str)
    ...
    $(".pic-del").click(function () {
        $(this).parent().parent().remove();
        $(this).parent().parent().before().remove();
    })
});